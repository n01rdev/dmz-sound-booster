...
impl RtcTimeProvider {
    ...
    pub fn now(&self) -> Result<DateTime, RtcError> {
        self.read(|dr, tr, _| {
            ...
            DateTime::from(year, month, day, weekday, hour, minute, second)
    ...
    fn read<R>(
        &self,
        mut f: impl FnMut(Dr, Tr, u16) -> Result<R, RtcError>,
    ) -> Result<R, RtcError> {
        let r = RTC::regs();
...
impl Rtc {
    ...
    pub(crate) fn start_wakeup_alarm(
        ...
        self.write(false, |regs| {
            ...
            #[cfg(any(
                rtc_v2f0, rtc_v2f2, rtc_v2f3, rtc_v2f4, rtc_v2f7, rtc_v2h7, rtc_v2l0, rtc_v2l1,
                rtc_v2l4, rtc_v2wb
            ))]
            {
        ...
        trace!(
            ...
            Duration::from_ticks(rtc_ticks as u64 * TICK_HZ * prescaler as u64 / rtc_hz)
                .as_millis(),
            prescaler as u32,
            rtc_ticks,
            instant,
    ...
    pub(crate) fn stop_wakeup_alarm(
        ...
        self.stop_time
            .borrow(cs)
            .take()
            .map(|stop_time| instant - stop_time)
    }
