...
impl<'d, T: Instance, Tx, Rx> Spi<'d, T, Tx, Rx> {
    ...
    pub fn new_subghz(
        ...
        let pclk3_freq =
            <peripherals::SUBGHZSPI as crate::rcc::sealed::RccPeripheral>::frequency().0;
...
macro_rules! impl_blocking {
    ($w:ident) => {
        impl<'d, T: Instance, Tx, Rx> embedded_hal_02::blocking::spi::Write<$w>
            for Spi<'d, T, Tx, Rx>
        {
            type Error = Error;
        ...
        impl<'d, T: Instance, Tx, Rx> embedded_hal_02::blocking::spi::Transfer<$w>
            for Spi<'d, T, Tx, Rx>
        {
            type Error = Error;
