...
pub(crate) mod sealed {
    ...
    pub trait ComplementaryCaptureCompare16bitInstance:
        CaptureCompare16bitInstance + AdvancedControlInstance
    {
    ...
    pub trait CaptureCompare32bitInstance:
        GeneralPurpose32bitInstance + CaptureCompare16bitInstance
    {
...
pub trait GeneralPurpose16bitInstance:
    sealed::GeneralPurpose16bitInstance + Basic16bitInstance + 'static
{
}
...
pub trait AdvancedControlInstance:
    sealed::AdvancedControlInstance + GeneralPurpose16bitInstance + 'static
{
}
