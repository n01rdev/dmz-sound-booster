...
use super::{
    blocking_read, ensure_sector_aligned, family, get_sector, Async, Error, Flash, FlashLayout,
...
impl<'d> Flash<'d, Async> {
    ...
    pub fn new(
        ...
        _irq: impl interrupt::typelevel::Binding<crate::interrupt::typelevel::FLASH, InterruptHandler>
            + 'd,
    ) -> Self {
        into_ref!(p);
...
pub(super) async unsafe fn write_chunked(
    base: u32,
    size: u32,
    offset: u32,
    bytes: &[u8],
