...
pub use crate::pac::rcc::vals::{
    Hpre as AHBPrescaler, Msirange as MSIRange, Ppre as APBPrescaler, Sw as ClockSrc,
};
...
pub(crate) unsafe fn init(config: Config) {
    ...
    #[cfg(any(stm32l0, stm32l1))]
    {
        ...
        crate::pac::PWR
            .cr()
            .write(|w| w.set_vos(config.voltage_scale));
        while crate::pac::PWR.csr().read().vosf() {}
    }
    ...
    #[cfg(any(stm32l4, stm32l5, stm32wb, stm32wl))]
    RCC.ccipr()
        .modify(|w| w.set_adcsel(config.adc_clock_source));
...
mod pll {
    use super::{pll_enable, PllInstance};
    pub use crate::pac::rcc::vals::{
        Pllm as PllPreDiv, Plln as PllMul, Pllp as PllPDiv, Pllq as PllQDiv, Pllr as PllRDiv,
        Pllsrc as PllSource,
    };
    use crate::pac::RCC;
    use crate::time::Hertz;
