...
impl<'d, M, BUS, CS, BusErr, CsErr> embedded_hal_02::blocking::spi::Transfer<u8>
    for SpiDevice<'_, M, BUS, CS>
where
    M: RawMutex,
...
impl<'d, M, BUS, CS, BusErr, CsErr> embedded_hal_02::blocking::spi::Write<u8>
    for SpiDevice<'_, M, BUS, CS>
where
    M: RawMutex,
