...
impl<M: RawMutex, T: Clone, const CAP: usize, const SUBS: usize, const PUBS: usize>
    PubSubBehavior<T> for PubSubChannel<M, T, CAP, SUBS, PUBS>
{
...
impl<T: Clone, const CAP: usize, const SUBS: usize, const PUBS: usize>
    PubSubState<T, CAP, SUBS, PUBS>
{
    ...
    fn try_publish(&mut self, message: T) -> Result<(), T> {
        ...
        self.queue
            .push_back((message, self.subscriber_count))
            .ok()
            .unwrap();
